function generatePDF() {
    ...
    doc.text("Alternate Contact Name: " + document.getElementById('altContactName').value, 20, 140);
    doc.text("Alternate Contact Number: " + document.getElementById('altContactNumber').value, 20, 150);
    doc.text("Email ID: " + document.getElementById('email').value, 20, 160);
    doc.text("Date of Payment Collected: " + document.getElementById('datePaymentCollected').value, 20, 170);
    doc.text("Order Taken Date: " + document.getElementById('orderTakenDate').value, 20, 180);
    doc.text("Promised Delivery: " + document.getElementById('deliveryMonths').value + " months", 20, 190);
