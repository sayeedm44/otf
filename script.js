function generatePDF() {
  ...
  doc.text("No of Stops: " + document.getElementById('noOfStops').value, 20, currentY);
  currentY += spacing;
  ...
  // Landing Door Type
  doc.text("Landing Door Type: " + document.getElementById('landingDoorType').value, 20, currentY);
  currentY += spacing;
  ...
  // Additional Details
  doc.text("Mirror Finish: " + document.getElementById('mirrorFinish').value, 20, currentY);
  currentY += spacing;
